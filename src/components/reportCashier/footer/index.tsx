...
interface FooterReportCashierProps {
    currentPage: number;
    onPageChange: (newPage: number) => void;
  }

const FooterReportCashier : React.FC<FooterReportCashierProps> = ({ currentPage, onPageChange }) => {
    return (
        // <Box display='flex' alignItems='center' justifyContent='space-between'>
        //    <Box>
        //     <Text color='#707070' fontFamily='Nunito' fontWeight='400' fontSize='14px'>Showing 7 of 90 Cashier</Text>
        //    </Box>
...
export default FooterReportCashier;