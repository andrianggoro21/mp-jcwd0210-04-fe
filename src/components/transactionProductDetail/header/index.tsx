...
const HeaderTransactionProduct = () => {
    const transactionId = localStorage.getItem("transactionId")
    return (
        <Box mb='40px'>
            <Box display='flex' alignItems='center' justifyContent='space-between'>
                <Text color='#000000' fontFamily="Nunito" fontWeight='700' fontSize='20px'>Transactions Detail {transactionId}</Text>
...
export default HeaderTransactionProduct;