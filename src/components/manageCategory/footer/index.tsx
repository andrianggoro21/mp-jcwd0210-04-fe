...
interface FooterManageCategoryProps {
    currentPage: number;
    onPageChange: (newPage: number) => void;
  }

const FooterManageCategory : React.FC<FooterManageCategoryProps> = ({ currentPage, onPageChange }) => {
    return (
        // <Box display='flex' alignItems='center' justifyContent='space-between'>
        //    <Box>
        //     <Text color='#707070' fontFamily='Nunito' fontWeight='400' fontSize='14px'>Showing 7 of 90 categories</Text>
        //    </Box>
...
export default FooterManageCategory;