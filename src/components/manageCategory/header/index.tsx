    ...
    return (
        <Box mb='40px'>
            <Box display='flex' alignItems='center' justifyContent='space-between'>
                <Text color='#000000' fontFamily="Nunito" fontWeight='700' fontSize='20px'>Manage Category</Text>
                <Box display='flex' alignItems='center' gap='18px'>
                    ...
                    <Button bgColor='#FF7940' color='#ffffff' display='flex' gap='10px' onClick={onOpen}> <IconPlus/> <Text>Create Category</Text> </Button>
                </Box>
