...
interface FooterManageProductProps {
    currentPage: number;
    onPageChange: (newPage: number) => void;
  }

const FooterManageProduct : React.FC<FooterManageProductProps> = ({ currentPage, onPageChange }) => {
    return (
...
export default FooterManageProduct;